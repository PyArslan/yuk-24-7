...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	foreach ($_POST as $name => $value) {
        ...
        // Втавляем запись с второстепенными полями
	...
	foreach($form_data as $name=>$value){
        ...
        $text .= $_POST['Cargo_name']."|";    
        $text .= $_POST['Cargo_category']."|";
        ...
        $text .= "Вес груза в тонн: ".$_POST['Weight_in_ton']."|";
        $text .= "Размер груза в m3: ".$_POST['Size_in_m3']."|";
        $text .= "Нужно таможенное оформление?: ".$_POST['Need_customs']."|";
...
<link href="css/addgruz.css" rel="stylesheet">
</head>
<body>
...
<h1 id="Heading2">Добавить заявку на Груз</h1>
</div>
</div>
<div class="col-3">
<div id="wb_Text20">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Укажите пожалуйста тип груза и другие необходимые данные, как можно подробнее!</span>
</div>
</div>
</div>
</div>
...
<form name="Add_Cargo" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Add_Cargo">
...
<div class="col-1">
<div id="wb_Text2">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Наименование груза</strong></span>
</div>
<input type="text" id="Cargo_name" style="display:block;width: 100%;height:31px;z-index:6;" name="Cargo_name" value="" spellcheck="false">
<div id="wb_Text3">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Категория груза</strong></span>
</div>
<select name="Cargo_category" size="1" id="Cargo_category" style="display:block;width: 100%;height:32px;z-index:8;">
...
<div id="wb_Text4">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Откуда забрать</strong></span>
</div>
...
<div id="wb_Text6">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Забрать груз не позже это даты</strong></span>
</div>
...
<input type="text" id="Editbox1" style="display:none;width: 100%;height:31px;z-index:15;" name="Application_type" value="Груз" readonly spellcheck="false">
<input type="text" id="Editbox2" style="display:none;width: 100%;height:31px;z-index:16;" name="Application_Status" value="Открыта" readonly spellcheck="false">
</div>
<div class="col-2">
<div id="wb_Text7">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Куда доставить</strong></span>
</div>
<select name="Where_to" size="1" id="Where_to" style="display:block;width: 100%;height:32px;z-index:18;">
<option value="">Выбрать страну</option>
<option value="Австрия">Австрия</option>
<option value="Азербайджан">Азербайджан</option>
<option value="Армения">Армения</option>
...
<div id="wb_Text8">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Город, адрес и т.д. (дост.)</strong></span>
</div>
<input type="text" id="Adress_2" style="display:block;width: 100%;height:31px;z-index:20;" name="Adress_2" value="" spellcheck="false">
<div id="wb_Text9">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Доставить груз не позже это даты</strong></span>
</div>
<input type="text" id="Finish_no_later" style="display:block;width: 100%;height:31px;z-index:22;" name="Finish_no_later" value="" spellcheck="false" placeholder="<?php echo $Finish_no_later_error;?>" onfocus="(this.type='date')">
<div id="wb_Text10">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Вес груза в тонн</strong></span>
</div>
<input type="number" id="Weight_in_ton" style="display:block;width: 100%;height:31px;z-index:24;" name="Weight_in_ton" value="0" spellcheck="false" step="0.01">
<div id="wb_Text11">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Размер груза в m3</strong></span>
</div>
<input type="number" id="Size_in_m3" style="display:block;width: 100%;height:31px;z-index:26;" name="Size_in_m3" value="0" spellcheck="false" step="0.1">
<div id="wb_Text12">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Нужно таможенное оформление?</strong></span>
</div>
<select name="Need_customs" size="1" id="Need_customs" style="display:block;width: 100%;height:32px;z-index:28;">
<option value=""></option>
...
<input type="number" id="Price_USD" style="display:block;width: 100%;height:31px;z-index:30;" name="Price_USD" value="0" spellcheck="false">
<div id="wb_Text14">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Условия оплаты</strong></span>
</div>
<select name="Terms_Payment" size="1" id="Terms_Payment" style="display:block;width: 100%;height:32px;z-index:32;">
<option value=""></option>
...
<input type="text" id="Comment" style="display:block;width: 100%;height:97px;z-index:34;" name="Comment" value="" spellcheck="false">
<div id="wb_Text16">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Кто добавил</strong></span>
</div>
<input type="text" id="Who_added" style="display:block;width: 100%;height:31px;z-index:36;" name="Who_added" value="<?php echo $_SESSION['FIO'];?>" spellcheck="false" placeholder="<?php echo $Who_added_error;?>">
<div id="wb_Text17">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>Телефон</strong></span>
</div>
<input type="text" id="Phone" style="display:block;width: 100%;height:31px;z-index:38;" name="Phone" value="<?php echo $_SESSION['Phone'];?>" spellcheck="false" placeholder="<?php echo $Phone_error;?>">
<div id="wb_Text18">
<span style="color:#000000;font-family:Arial;font-size:13px;"><strong>E-mail</strong></span>
</div>
<input type="text" id="Email" style="display:block;width: 100%;height:31px;z-index:40;" name="Email" value="<?php echo $_SESSION['Email'];?>" spellcheck="false" placeholder="<?php echo $Email_error;?>">
<input type="submit" id="Button2" name="" value="Добавить" style="display:inline-block;width:98px;height:35px;z-index:41;">
<a id="Button3" href="./yuk247.php" style="display:inline-block;width:98px;height:35px;z-index:42;">Вернуться</a>
</div>
</div>
</div>
</div>
